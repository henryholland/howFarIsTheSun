...
public float[] plotMarkerPos(float circle_x, float circle_y, float circle_r, float marker_a) {
  float[] pos = { 
...
public void drawMarkerHitArea(float marker_x, float marker_y, float marker_r) {
  noStroke();
  fill(255, 0, 0);
  ellipseMode(CENTER);
...
public float angleFromCircleCentre(float circle_x, float circle_y) {
